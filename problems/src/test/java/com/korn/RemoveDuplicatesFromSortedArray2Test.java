...
class RemoveDuplicatesFromSortedArray2Test {
    ...
    void removeDuplicates(int[] inputNums, int[] expectedNums, int expectedLength) {
        int actualLength = new RemoveDuplicatesFromSortedArray2().removeDuplicates(inputNums);
    ...
    static Stream<Arguments> removeDuplicates() {
        return Stream.of(
                ...
                Arguments.of(new int[]{1, 1, 1, 1, 1, 1, 1, 1, 2, 2, 2}, new int[]{1, 1, 2, 2}, 4),
                Arguments.of(new int[]{1}, new int[]{1}, 1),
                Arguments.of(new int[]{1, 1}, new int[]{1, 1}, 2)
        );
    }
}